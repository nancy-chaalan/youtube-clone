...
describe('AppComponent', () => {
  ...
  it('should load translations', async(() => {
    ...
    http.expectNone('/assets/i18n/ar.json');
    ...
    translate.use('ar');
    http.expectOne('/assets/i18n/ar.json').flush(TRANSLATIONS_AR);
    ...
    expect(compiled.querySelector('h2').textContent).toEqual(TRANSLATIONS_AR.HOME.TITLE);
  }));
});